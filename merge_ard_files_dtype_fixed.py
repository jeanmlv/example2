...
def merge_ard_tables(
    ...
    for filename, current in ard_tables.items():
        ...
        # Use object dtype so numeric columns can also store combined values
        # such as "1.0 | 6.0" when populated values conflict.
        current = current.set_index(keys).astype(object)
